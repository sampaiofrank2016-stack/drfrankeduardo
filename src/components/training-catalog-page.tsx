...
export default function TrainingCatalogPage({
  ...
  const comingSoonProducts = products.filter(
    (product) =>
      product.status === "soon" &&
      (product.href === "#" || product.href.trim() === ""),
  );
      ...
      <section className="catalog-products-section" id="catalogo">
        <div className="container">
          <div className="section-heading catalog-products-heading">
            <div>
              <span className="eyebrow">Conteúdos e treinamentos</span>
              <h2>{productsTitle}</h2>
            </div>
          ...
          <div className="catalog-products-grid">
            {catalogProducts.map((product, index) => {
              const isWaitlist = product.status === "soon";
              ...
              return (
                ...
                >
                  <div className="catalog-product-header">
                    ...
                    <span className="catalog-product-status">
                      {isWaitlist ? "Em preparação" : "Disponível"}
                    </span>
                  </div>
                  ...
                  <div className="catalog-product-details">
                    ...
                    <div>
                      <span>{isWaitlist ? "Status" : "Acesso"}</span>
                      <strong>
                        {isWaitlist
