...
export const metadata: Metadata = {
  ...
  description:
    "Conteúdos sobre fisioterapia, osteopatia, dor, coluna, fibromialgia, movimento e qualidade de vida escritos pelo Dr. Frank Eduardo.",
  keywords: [
...
const articles = [
  ...
  },
  {
    ...
    description:
      "Entenda o que é fibromialgia, seus principais sintomas, como é feito o diagnóstico e quais estratégias podem ajudar no controle da dor e na qualidade de vida.",
...
export default function ArticlesPage() {
  ...
  const publishedArticles = articles.filter((article) => !article.featured);
  ...
  const websiteSchema = {
    ...
    description:
      "Conteúdos sobre fisioterapia, osteopatia, dor, movimento, fibromialgia e qualidade de vida.",
    url: `${siteUrl}/artigos`,
    inLanguage: "pt-BR",
    isPartOf: {
      "@type": "WebSite",
    ...
    hasPart: articles.map((article) => ({
      ...
      datePublished:
        article.slug === "fibromialgia" ? "2026-08-03" : "2026-07-28",
      author: {
        "@type": "Person",
        name: "Dr. Frank Eduardo",
      },
          ...
          <div className={`container ${styles.heroContent}`}>
            ...
            <div className={styles.heroGrid}>
              <div>
                ...
                <h1>
                  Informação para entender melhor <span>o seu corpo.</span>
                </h1>
        ...
        <section className={styles.librarySection}>
          <div className="container">
            <div className={styles.libraryHeading}>
              ...
              <p>
                Artigos conectados entre si para ajudar você a compreender
                melhor dor, movimento, saúde e qualidade de vida.
              </p>
            </div>
        ...
        <section className={styles.librarySection}>
          <div className="container">
            <div className={styles.libraryHeading}>
              ...
              <p>
                A biblioteca continuará crescendo com novos artigos conectados
                aos conteúdos do site e do canal Professor Fisio.
              </p>
            </div>
